...
module.exports = async function(deployer, network, addresses) {
  ...
  if (network === 'kovan') {
    // sUSD
    await deployer.deploy(HTLC, a2, '0xF92e70301E26AaDeCCEc5016b7D0167DAF416d72', ethers.utils.formatEther('5'), {from: a1});
    ...
    // DAI
    await deployer.deploy(HTLC, a1, '0xEC5dCb5Dbf4B114C9d0F65BcCAb49EC54F6A0867', ethers.utils.formatEther('5'), {from: a2});
    const htlc = await htlc.deployed();
